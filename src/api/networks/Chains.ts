...
export const unilendTestnet = {
  ...
  rpcUrls: {
    default: {
      http: ["https://rpc.buildbear.io/honest-spiderwoman-6c6fbc8e"],
    },
    public: {
      http: ["https://rpc.buildbear.io/honest-spiderwoman-6c6fbc8e"],
    },
...
export const arbitrumTestnet = {
  ...
  rpcUrls: {
    default: {
      http: ["https://rpc.buildbear.io/curved-kingpin-888be07c"],
    },
    public: {
      http: ["https://rpc.buildbear.io/curved-kingpin-888be07c"],
    },
  ...
  blockExplorers: {
    default: {
      name: "explore",
      url: "https://explorer.buildbear.io/curved-kingpin-888be07c/transactions",
    },
  },
  testnet: true,
} as Chain;
