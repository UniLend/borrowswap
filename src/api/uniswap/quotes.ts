...
import {
  ...
  USDT_TOKEN, WETH_TOKEN ,CURV_TOKEN
} from '../../helpers/constants'

import { toReadableAmount, fromReadableAmount, fromBigNumber, fixed2Decimals } from '../../helpers'
...
export async function quote(amountIn: number){
  ...
  const quoterContract = await getEtherContract(QUOTER_CONTRACT_ADDRESS,  Quoter.abi)
